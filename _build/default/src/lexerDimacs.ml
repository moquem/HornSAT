...
let __ocaml_lex_tables = {
  Lexing.lex_base =
   "\000\000\245\255\246\255\009\000\019\000\248\255\249\255\250\255\
    \000\000\000\000\254\255\001\000\000\000\253\255\001\000\252\255\
    \251\255\029\000\001\000\254\255\255\255";
  Lexing.lex_backtrk =
   "\255\255\255\255\255\255\010\000\008\000\255\255\255\255\255\255\
    \010\000\010\000\255\255\000\000\255\255\255\255\255\255\255\255\
    \255\255\008\000\255\255\255\255\255\255";
  Lexing.lex_default =
  ...
  Lexing.lex_trans =
   "\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\
    ...
    \000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\
    \000\000\000\000\000\000\011\000\000\000\000\000\013\000\015\000\
    \008\000\000\000\000\000\000\000\000\000\000\000\014\000\012\000\
    \010\000\000\000\000\000\016\000\000\000\000\000\000\000\000\000\
  ...
  Lexing.lex_check =
   "\255\255\255\255\255\255\255\255\255\255\255\255\255\255\255\255\
    ...
    \255\255\255\255\255\255\255\255\255\255\255\255\255\255\255\255\
    \255\255\255\255\255\255\000\000\255\255\255\255\012\000\014\000\
    \000\000\255\255\255\255\255\255\255\255\255\255\009\000\011\000\
    \000\000\255\255\255\255\008\000\255\255\255\255\255\255\255\255\
    \000\000\255\255\255\255\255\255\255\255\255\255\255\255\255\255\
    \255\255\255\255\255\255\255\255\255\255\255\255\255\255\255\255\
    \255\255\255\255\255\255\255\255\255\255\255\255\255\255\255\255\
    \255\255\255\255\255\255\255\255\255\255\255\255\255\255\255\255\
...
# 172 "src/lexerDimacs.ml"

  | 9 ->
# 43 "src/lexerDimacs.mll"
                    ( Lexing.new_line lexbuf; NEWLINE )
# 177 "src/lexerDimacs.ml"

  | 10 ->
let
# 44 "src/lexerDimacs.mll"
         c
# 183 "src/lexerDimacs.ml"
= Lexing.sub_lexeme_char lexbuf lexbuf.Lexing.lex_start_pos in
# 44 "src/lexerDimacs.mll"
                    ( unexpected_char lexbuf c )
# 187 "src/lexerDimacs.ml"
...
and __ocaml_lex_comment_rec lexbuf __ocaml_lex_state =
  match Lexing.engine __ocaml_lex_tables __ocaml_lex_state lexbuf with
      | 0 ->
# 47 "src/lexerDimacs.mll"
          ( Lexing.new_line lexbuf; token lexbuf )
# 199 "src/lexerDimacs.ml"

  | 1 ->
# 48 "src/lexerDimacs.mll"
                   ( comment lexbuf )
# 204 "src/lexerDimacs.ml"
